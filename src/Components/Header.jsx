  ...
  return (
    <header className="bg-p1 border-gray-300 flex border-b border-p8">
      ...
      <div className="max-w-2xl mx-auto font-mono text-center  backdrop-blur-md">
        ...
        <h1 className="pt-7 font-sans font-bold text-logo border-p1 text-4xl">SEIN </h1>
        <p className="text-logo text-center text-base"> Libertador</p>
        </div>
      </div>
      <div className="flex">
        <div className="h-full flex items-center justify-center">
          <a href="https://wa.me/3329676205"><FaWhatsapp className="text-xl text-p4 m-4 shadow-lg" /></a>
        </div>
        <div className="h-full flex items-center justify-center">
